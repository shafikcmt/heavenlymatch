...
return [
    ...
    'basic_info_subtitle'  => 'Tell us the essential biodata information.',
    'birth_day'            => 'Birth Date',
    'birth_month'          => 'Birth Month',
    'birth_year'           => 'Birth Year',
    'dob_invalid'          => 'Please choose a valid date of birth.',
    'physical_status'      => 'Physical Status',
    'health_issue_details' => 'Health / Disability Details',
    'health_issue_details_ph' => 'Briefly describe the condition (only if applicable)',
    ...
    'present_address_help'       => 'Where you currently live.',
    'permanent_address_help'     => 'Your permanent / home address.',
    'permanent_same_as_present'  => 'Permanent address is same as present address',
    'permanent_same_summary'     => 'Permanent address will be saved the same as your present address.',
    'addr_country'      => 'Country',
    'addr_country_ph'   => 'e.g. Bangladesh, UK…',
    'addr_state'        => 'State / Province',
    'addr_state_ph'     => 'e.g. California',
    'addr_city'         => 'City',
    'addr_city_ph'      => 'e.g. London',
    'addr_area'         => 'Area / Village',
    'addr_area_ph'      => 'e.g. Banani, village name',
    ...
    'edu_select_highest_first'    => 'Please select your highest qualification first. Education fields will appear based on your selection.',
    'education_records'           => 'Education Records',
    'education_records_help'      => 'Add a record for each level up to your highest qualification.',
    'edu_no_records'              => 'No education records yet.',
    'edu_record_level'            => 'Degree / Level',
    'edu_add_record'              => 'Add Education Record',
    'edu_add_specific'            => 'Add :level Record',
    'edu_all_levels_added'        => 'All required education records added.',
    ...
    // Low qualification (below SSC-equivalent): no detailed records needed.
    'edu_low_qual_title'          => 'Detailed education records are not required for this qualification.',
    'edu_low_qual_desc'           => 'You can optionally add a short note about your education below.',
    'edu_low_qual_note_label'     => 'Education Details / Note (optional)',
    'edu_low_qual_note_ph'        => 'e.g. Studied up to Class 8',
    'edu_low_qual_review'         => 'You have detailed records saved that are not needed for this qualification. Review or remove them below.',
    ...
    'occupation_ph'           => 'e.g. Software Engineer',
    'monthly_income_ph'       => 'e.g. 50000',
    'monthly_income_help'     => 'Numbers only, in BDT. Leave blank to skip.',
    'profession_details_ph'   => 'Brief description of your work, company, or studies…',
    'income_type'             => 'Income Type',
    'income_type_monthly'     => 'Fixed Monthly Salary',
    'income_type_business'    => 'Business Income',
    'income_type_freelance'   => 'Freelance / Project Based',
    'income_type_daily'       => 'Daily / Contract Based',
    'income_type_yearly'      => 'Yearly',
    'income_type_variable'    => 'Not Fixed',
    'income_type_private'     => 'Prefer not to say',
    'income_privacy'          => 'Income Visibility',
    'income_privacy_help'     => 'Control who can see your income on your profile.',
    'income_privacy_public'   => 'Show exact income',
    'income_privacy_range'    => 'Show income range only',
    'income_privacy_members'  => 'Show only to accepted contacts',
    'income_privacy_private'  => 'Hide income from public profile',
    'profession_halal_status'  => 'Is your income halal?',
    'profession_halal_help'    => 'Answer honestly. This helps compatible matching.',
    'halal_status_halal'       => 'Yes, halal',
    'halal_status_alternative' => 'Mostly halal / trying to improve',
    'halal_status_not_sure'    => 'Not sure',
    'halal_status_prefer_not_say' => 'Prefer not to say',
