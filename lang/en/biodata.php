...
return [
    ...
    'education_system_help'       => 'Choose your education system first — qualification options adjust accordingly.',
    'edu_select_system_first'     => 'Select an education system first.',
    'education_records'           => 'Education Records',
    'education_records_help'      => 'Add education records up to your highest qualification. আপনার সর্বোচ্চ শিক্ষাগত যোগ্যতা অনুযায়ী নিচের শিক্ষা রেকর্ড যুক্ত করুন।',
    'edu_no_records'              => 'No education records yet.',
    'edu_record_level'            => 'Degree / Level',
    'edu_add_record'              => 'Add Education Record',
    'edu_all_levels_added'        => 'All relevant education levels are already added.',
    'edu_level_too_high'          => 'This level is higher than your highest qualification.',
    'edu_system_changed_notice'   => 'Education system changed. Please review your qualification and records.',
    'edu_highest_changed_notice'  => 'Highest qualification changed. Please review records that may now be invalid.',
    'edu_fix_records_notice'      => 'Some education records are higher than your highest qualification. Please fix them before continuing.',

    // Level labels — General / English Medium / Vocational
    'lvl_below_class5'  => 'Below Class 5',
    'lvl_class5'        => 'Class 5',
    'lvl_class8'        => 'Class 8 / JSC',
    'lvl_ssc'           => 'SSC / O Level',
    'lvl_hsc'           => 'HSC / A Level',
    'lvl_diploma'       => 'Diploma',
    'lvl_bachelor'      => 'Bachelor / Honours',
    'lvl_masters'       => 'Masters',
    'lvl_phd'           => 'PhD / Doctorate',
    'lvl_o_level'       => 'O Level',
    'lvl_a_level'       => 'A Level',
    'lvl_ssc_voc'       => 'SSC Vocational',
    'lvl_hsc_voc'       => 'HSC Vocational',
    'lvl_other'         => 'Other',
    // Level labels — Qawmi
    'lvl_hifz'          => 'Hifz-e-Quran',
    'lvl_maktab'        => 'Maktab / Primary',
    'lvl_mutawassitah'  => 'Mutawassitah',
    'lvl_sanawiyah'     => 'Sanawiyah',
    'lvl_fazilat'       => 'Fazilat',
    'lvl_takmil'        => 'Takmil / Dawra-e-Hadith',
    'lvl_ifta'          => 'Ifta / Takhassus',
    // Level labels — Alia
    'lvl_ebtedayee'     => 'Ebtedayee',
    'lvl_jdc'           => 'JDC',
    'lvl_dakhil'        => 'Dakhil',
    'lvl_alim'          => 'Alim',
    'lvl_fazil'         => 'Fazil',
