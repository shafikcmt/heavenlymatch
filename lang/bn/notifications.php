...
return [
    ...
    'biodata_hidden_title'    => 'বায়োডাটা লুকানো হয়েছে',
    'biodata_hidden_body'     => 'আমাদের টিম সাময়িকভাবে আপনার বায়োডাটা লুকিয়ে রেখেছে এবং এটি এখন সদস্যদের কাছে দৃশ্যমান নয়।',
    'biodata_unhidden_title'  => 'বায়োডাটা পুনরায় দৃশ্যমান',
    'biodata_unhidden_body'   => 'আপনার বায়োডাটা আবার সদস্যদের কাছে দৃশ্যমান।',
    ...
    // ── Daily matches ─────────────────────────────────────────────────────────
    'daily_match_title'         => 'আপনার জন্য :count টি নতুন ম্যাচ',
    'daily_match_title_generic' => 'নতুন ম্যাচ পরামর্শ প্রস্তুত',
    'daily_match_body'          => 'আজকের পরামর্শ দেখতে আপনার ম্যাচ পেজ পরিদর্শন করুন।',

    // ── Re-engagement ─────────────────────────────────────────────────────────
    'reengagement_title'        => 'আপনাকে HeavenlyMatch-এ মিস করছি',
    'reengagement_body'         => 'নতুন প্রোফাইল অপেক্ষা করছে। আপনার সর্বশেষ ম্যাচ পরামর্শ দেখতে লগইন করুন।',
    ...
    // ── Reports ───────────────────────────────────────────────────────────────
    'report_resolved_title'   => 'রিপোর্ট পর্যালোচনা করা হয়েছে',
    'report_resolved_body'    => 'আপনার রিপোর্ট আমাদের টিম পর্যালোচনা করেছে। HeavenlyMatch নিরাপদ রাখতে সহায়তার জন্য ধন্যবাদ।',
